...
Завантажити ілюстрацію
  ...
  brizol.Завантажити документ   ${username}  ${filepath}  ${tender_uaid}  True
...
Задати запитання на тендер
  ...
  brizol.Задати питання  ${username}  ${tender_uaid}  ${question}

Задати запитання на предмет
  [Arguments]  ${username}  ${tender_uaid}  ${item_id}  ${question}
  brizol.Задати питання  ${username}  ${tender_uaid}  ${question}  ${item_id}
...
Отримати документ
  ...
  brizol_download_file   ${url}  ${file_name}  ${OUTPUT_DIR}
  [return]  ${file_name}
...
Завантажити документ в ставку
  ...
  ...  brizol.Отримати інформацію із пропозиції  ${username}  ${tender_uaid}  ${EMPTY}
  ...  AND  brizol.Скасувати цінову пропозицію  ${username}  ${tender_uaid}
...
Завантажити фінансову ліцензію
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}
  brizol.Завантажити документ в ставку  ${username}  ${filepath}  ${tender_uaid}

Змінити документ в ставці
  [Arguments]  ${username}  ${tender_uaid}  ${path}  ${docid}
  brizol.Завантажити документ в ставку  ${username}  ${path}  ${tender_uaid}
